        ...
        <Box
            ...
            <Box p={6}>
                <Stack spacing={0} align={'center'} mb={5}>
                    ...
                    <Text color={'gray.500'} fontSize={"xl"}  textAlign="center">{props.year}</Text>
                    <Text color={'gray.500'} fontSize={"xl"}  textAlign="center">{props.college}</Text>
                    <Text color={'gray.500'} fontSize={"xl"}  textAlign="center">{props.department}</Text>
                </Stack>
